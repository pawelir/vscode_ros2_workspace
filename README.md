...
This repository will get you set up using ROS2 with VSCode as your IDE.

See this [article](https://www.allisonthackston.com/articles/vscode_docker_ros2.html) for a more in-depth look on how to use this workspace.
...
4. (optional) Adjust scripts to your liking.  These scripts are used both within tasks and CI.
   ...
   * `build.sh` The build commands for your code.  Default to `--symlink-install`
